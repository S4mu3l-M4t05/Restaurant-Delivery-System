...
public class RestaurantEditController implements ActionListener, ListSelectionListener {
	private RestaurantEditModel model;
	private RestaurantEditView view;
	DefaultListModel<String> listModel = new DefaultListModel<>();

	String array;

	public RestaurantEditController(RestaurantEditModel model, RestaurantEditView view) {
		this.model = model;
		this.view = view;
		insertData();
...
//		all the buttons
		...
		view.getBtnDeactivate().addActionListener(this);
//		menubar
		...
		// Keylisteners to make sure no numbers are used for the restaurant name
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == view.getBtnDeactivate()) {
			JFrame frame = new JFrame("Deactivate");
			boolean choices = JOptionPane.showConfirmDialog(frame,
					"Are you sure you want to Deactivate this Restaurant", "Deactivate",
...
//				this checks to make sure the delivery list isn't empty
	...
	private void insertData() {
		...
		List<String> restaurants = restaurantEditModel.getallrestaurantsandaddress();
	...
	@Override
//	 this code communicates with the jlist for when you click on an item
...
//	this is the code that updates the table
	...
	public void deactivate() {
		...
		model.changeStatusbyID(resto, number);
