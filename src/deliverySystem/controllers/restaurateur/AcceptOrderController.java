...
public class AcceptOrderController implements ActionListener {
    ...
    public AcceptOrderController(AcceptOrderView view, RestaurateurModel model) {
        this.view = view;
        this.model = model;
            ...
            public void actionPerformed(ActionEvent e) {
                  ...
                  if (selectedIndex != -1) {
                      ...
                      if (selectedOrder != null) {
                          ...
                          view.getDeliveryPC().setText(date);
        ...
        if (!view.getDeliverydate().getText().equals("")) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                if (selectedIndex != -1) { // Check if an item is selected
                    model.updateOrderStatus(ordersIDList.get(selectedIndex), "Accepted");
