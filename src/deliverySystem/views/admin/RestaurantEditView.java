...
public class RestaurantEditView extends JFrame {
	...
	JButton btnDeactivate = new JButton("Deactivate a Restaurant");
	...
	private void initialize() {
		...
		btnDeactivate.setBackground(new Color(255, 255, 255));

		btnDeactivate.setBounds(33, 691, 246, 32);
		btnDeactivate.setForeground(Color.decode("#212f40"));
		panel.add(btnDeactivate);
		btnDeactivate.setFont(new Font("JetBrains Mono NL SemiBold", Font.PLAIN, 11));
	...
	/**
	 * @param btnDeactivate the btnDeactivate to set
	 */
	public void setBtnDeactivate(JButton btnDeactivate) {
